...
Class RepoAlergenos{
    ...
    public function createAlergeno(): void{

    }

    public function readAlergeno(String $idalergeno){
        $stm=$this->con->prepare("select * from alergeno where marca=:marca and modelo=:modelo");
    ...
    public function deleteAlergeno(String $marca,String $modelo):void{
        $stm=$this->con->prepare("delete from coche where marca=:marca and modelo=:modelo");
        $stm->execute([':marca'=>$marca,':modelo'=>$modelo]);
        
    }

    public function updateAlergeno():void{
