...
Class RepoPedidoTieneKebab{
    ...
    public function createPedidoTieneKebab(): void{

    }

    public function readPedidoTieneKebab(String $marca, String $modelo){
    ...
    public function deletePedidoTieneKebab(String $marca,String $modelo):void{
        $stm=$this->con->prepare("delete from coche where marca=:marca and modelo=:modelo");
        $stm->execute([':marca'=>$marca,':modelo'=>$modelo]);
        
    }

    public function updatePedidoTieneKebab():void{
