...
Class RepoDireccion{
    ...
    public function createDireccion(): void{

    }

    public function readDireccion(String $marca, String $modelo){
    ...
    public function deleteDireccion(String $marca,String $modelo):void{
        $stm=$this->con->prepare("delete from coche where marca=:marca and modelo=:modelo");
        $stm->execute([':marca'=>$marca,':modelo'=>$modelo]);
        
    }

    public function updateDireccion():void{
