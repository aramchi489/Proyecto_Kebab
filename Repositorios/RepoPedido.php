...
Class RepoPedido{
    ...
    public function createPedido(): void{

    }

    public function readPedido(String $marca, String $modelo){
    ...
    public function deletePedido(String $marca,String $modelo):void{
        $stm=$this->con->prepare("delete from coche where marca=:marca and modelo=:modelo");
        $stm->execute([':marca'=>$marca,':modelo'=>$modelo]);
        
    }

    public function updatePedido():void{
