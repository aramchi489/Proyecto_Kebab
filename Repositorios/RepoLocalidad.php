...
Class RepoLocalidad{
    ...
    public function createLocalidad(): void{

    }

    public function readLocalidad(String $marca, String $modelo){
    ...
    public function deleteLocalidad(String $marca,String $modelo):void{
        $stm=$this->con->prepare("delete from coche where marca=:marca and modelo=:modelo");
        $stm->execute([':marca'=>$marca,':modelo'=>$modelo]);
        
    }

    public function updateLocalidad():void{
